    ...
    <div className="p-4 sm:ml-64 bg-slate-100">
       <div className="sm:flex sm:flex-row mt-16">
        <div className="flex flex-row bg-white rounded-lg p-4 mx-2 w-full justify-between mt-2">
            <div>
            <p className="text-slate-400 text-xs font-bold font-['Poppins'] leading-[18px]">Today’s Money</p>
            <div className="flex flex-row">
                <p className="text-gray-700 text-lg font-bold font-['Poppins'] leading-relaxed">$53,000</p>
                <span className=" text-green-400 text-sm font-bold font-['Poppins'] leading-tight mt-1 ml-2">+55%</span>
            </div>
            </div>
        ...
        <div className="flex flex-row bg-white rounded-lg p-4 mx-2 w-full justify-between mt-2">
            <div>
            <p className="text-slate-400 text-xs font-bold font-['Poppins'] leading-[18px]">Today’s User</p>
            <div className="flex flex-row">
                <p className="text-gray-700 text-lg font-bold font-['Poppins'] leading-relaxed">2,300</p>
                <span className=" text-green-400 text-sm font-bold font-['Poppins'] leading-tight mt-1 ml-2">+5%</span>
            </div>
            </div>
            <div className="bg-green-700 p-2 rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="text-white mt-1" viewBox="0 0 16 16">
        ...
        <div className="flex flex-row bg-white rounded-lg p-4 mx-2 w-full justify-between mt-2">
            <div>
            <p className="text-slate-400 text-xs font-bold font-['Poppins'] leading-[18px]">Total Export</p>
            <div className="flex flex-row">
                <p className="text-gray-700 text-lg font-bold font-['Poppins'] leading-relaxed">+3,052</p>
        ...
        <div className="flex flex-row bg-white rounded-lg p-4 mx-2 w-full justify-between mt-2">
            <div>
            <p className="text-slate-400 text-xs font-bold font-['Poppins'] leading-[18px]">Report</p>
            <div className="flex flex-row">
       ...
       <div className="flex sm:flex-row flex-col-reverse mt-2">
        <div className="sm:w-2/3 px-4">
            <div className="bg-white rounded-lg p-4 mx-2 w-full mt-2">
                ...
                <p className="bg-green-700 text-white font-bold sm:w-1/2 py-2 px-2 text-center text-2xl rounded-lg">
                    HEIS DASHBOARD
                </p>
                </div>
        ...
        <div className="sm:w-1/3 px-2">
            ...
            <div className="bg-gradient-to-r from-green-800 to-black rounded-lg p-4 sm:w-full sm:mx-2 mt-4">
                <ActiveChart />
            </div>
        </div>
       </div>
            ...
            <div className="bg-white rounded-md m-2 w-full">
                <div className="flex flex-row justify-between m-1">
                    <div className="flex flex-row">
                        ...
                        <p className="text-slate-400 text-md font-bold font-['Poppins'] leading-[18px] m-1">Users</p>
                    </div>
                    <p className="text-gray-700 text-lg font-bold font-['Poppins'] leading-relaxed">500</p>
                </div>
                <div className="p-1">
            ...
            <div className="bg-white rounded-md m-2 w-full">
                <div className="flex flex-row justify-between m-1">
                    <div className="flex flex-row">
                        ...
                        <p className="text-slate-400 text-md font-bold font-['Poppins'] leading-[18px] m-1">Export volume</p>
                    </div>
                    <p className="text-gray-700 text-lg font-bold font-['Poppins'] leading-relaxed">2,42m</p>
                </div>
                <div className="p-1">
                    <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
            ...
            <div className="bg-white rounded-md m-2 w-full">
                <div className="flex flex-row justify-between m-1">
                    <div className="flex flex-row">
                        ...
                        <p className="text-slate-400 text-md font-bold font-['Poppins'] leading-[18px] m-1">Report</p>
                    </div>
                    <p className="text-gray-700 text-lg font-bold font-['Poppins'] leading-relaxed">2,400</p>
                </div>
                <div className="p-1">
                    <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
            ...
            <div className="bg-white rounded-md m-2 w-full">
                <div className="flex flex-row justify-between m-1">
                    <div className="flex flex-row">
                        ...
                        <p className="text-slate-400 text-md font-bold font-['Poppins'] leading-[18px] m-1">Export Lists</p>
                    </div>
       ...
       <div className="flex flex-row w-full mt-2">
            ...
            <div className="bg-white mx-2 sm:w-1/4 w-full rounded-md">
                <h3 className="text-semibold font-lg text-black pl-2 pt-1">List Of Companies Registered</h3>
                <p className="text-gray-300 font-md text-semibold pl-2 mb-2"><span className="text-green-300">+30%</span> this month</p>
                <CompanyCard 
                    companyName="Abracadabra Company LTD"
                    companyClass="font-bold text-md text-gray-700"
                    tinNo="TIN NO: XXXXXXX"
                    tinClass="text-gray-300 font-bold text-sm vert-line"
                    containerClass=""
                />
                <CompanyCard 
                    companyName="Isaro Company LTD"
                    companyClass="font-bold text-md text-gray-700"
                    tinNo="TIN NO: XXXXXXX"
                    tinClass="text-gray-300 font-bold text-sm vert-line"
                    containerClass=""
                />
                <CompanyCard 
                    companyName="Eden Care Company LTD"
                    companyClass="font-bold text-md text-gray-700"
                    tinNo="TIN NO: XXXXXXX"
                    tinClass="text-gray-300 font-bold text-sm vert-line"
                    containerClass=""
                />
                <CompanyCard 
                    companyName="Ikawa yacu Company LTD"
                    companyClass="font-bold text-md text-gray-700"
                    tinNo="TIN NO: XXXXXXX"
                    tinClass="text-gray-300 font-bold text-sm vert-line"
                    containerClass=""
