       ...
       <div className="sm:flex sm:flex-row mt-16">
        <div className="flex flex-row bg-white rounded-lg p-4 mx-2 w-full justify-between mt-2">
            ...
            <div className="flex flex-row">
                ...
                <span className=" text-blue-500 text-sm font-bold font-['Poppins'] leading-tight mt-1 ml-2">+20%</span>
            </div>
            </div>
        ...
        <div className="flex flex-row bg-white rounded-lg p-4 mx-2 w-full justify-between mt-2">
            ...
            <div className="flex flex-row">
                ...
                <span className=" text-blue-500 text-sm font-bold font-['Poppins'] leading-tight mt-1 ml-2">+5%</span>
            </div>
            </div>
            <div className="bg-blue-500 p-2 rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="text-white mt-1" viewBox="0 0 16 16">
        ...
        <div className="flex flex-row bg-white rounded-lg p-4 mx-2 w-full justify-between mt-2">
            ...
            <div className="flex flex-row">
                ...
                <span className=" text-blue-500 text-sm font-bold font-['Poppins'] leading-tight mt-1 ml-2">+55%</span>
            </div>
            </div>
            <div className="bg-blue-500 p-2 rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="text-white mt-1" viewBox="0 0 16 16">
       ...
       <div className="flex sm:flex-row flex-col-reverse mt-2">
        <div className="sm:w-2/3 px-4">
            <div className="bg-white rounded-lg p-4 mx-2 w-full mt-2">
                ...
                <p className="bg-blue-500 text-white font-bold sm:w-1/2 py-2 px-2 text-center text-2xl rounded-lg">
                    APPORIS DASHBOARD
                </p>
                </div>
            ...
            <div className="bg-white rounded-lg p-4 mt-4">
                ...
                <span className="text-sm text-blue-500 font-semibold">20% expired</span>
                <ExportChart />
            </div>
        </div>
