...
function UserDashboard() {
  return (
    ...
    <div className="p-4 sm:ml-64 bg-slate-100 pt-16">
       ...
       <p className="text-slate-400 text-xl font-bold font-['Poppins'] leading-[18px] ml-4">Mugisha Moise</p>
       <div className="flex sm:flex-row flex-col-reverse mt-2">
         <div className='sm:w-2/3'>
            ...
            <div className="bg-white rounded-lg p-4 mx-2 w-full justify-between mt-2">
                  <p className="text-slate-400 text-lg font-bold font-['Poppins'] leading-[18px]">Employees Reports</p>
                  <span className=" text-black text-xl font-bold font-['Poppins'] leading-tight mt-1 ml-2">500</span>
