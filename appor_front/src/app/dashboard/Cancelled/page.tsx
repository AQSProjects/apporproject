...
import Popupbutton from '../../../components/dasboard/popupbutton'
const CancelledCompanies = () => {
 return (
      <>
       <Sidebar />
         <Navbar />
         <main className="p-4 sm:ml-64 mt-16">
           <h1 className="text-2xl font-semibold mb-4">Cancelled Companies</h1>
             ...
             <table id="ApprovedCompanies" className="w-full">
               ...
               <tbody>
                 <tr>
                   ...
                   <td className="p-2 border text-red-600 font-semibold">Cancelled</td>
                   <td className="p-2 border"><Popupbutton/></td>
                </tr>
                <tr>
 ...
 export default CancelledCompanies;