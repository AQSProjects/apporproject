    ...
    <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0" aria-label="Sidebar">
       <div className="h-full px-3 pb-4 overflow-y-auto bg-white">
          <ul className="space-y-2 font-medium">
             <li>
                <Link href="/dashboard/appor" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-blue-400 group hover:font-bold hover:text-white">
             ...
             <li>
                <Link href="/dashboard/nurses" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-blue-400 group hover:font-bold hover:text-white">
                   <div className=" bg-slate-100 px-2 py-1 rounded-lg group-hover:bg-blue-600 ">
             ...
             <li>
                <Link href="/dashboard/pharmacists" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-blue-400 group hover:font-bold hover:text-white">
                <div className=" bg-slate-100 px-2 py-1 rounded-lg group-hover:bg-blue-600 ">
