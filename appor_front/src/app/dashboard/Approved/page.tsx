...
import Popup from '../../../../src/components/dasboard/popup'
      ...
      <>
       <Sidebar />
         ...
         <main className="p-4 sm:ml-64 mt-16">
           <h1 className="text-2xl font-semibold mb-4">Approved Companies</h1>
             ...
             <table id="ApprovedCompanies" className="w-full">
               ...
               <tbody>
                 <tr>
                   ...
                   <td className="p-2 border text-green-600 font-semibold">Approved</td>
                   <td className="p-2 border"><Popup/></td>
                </tr>
                <tr>
